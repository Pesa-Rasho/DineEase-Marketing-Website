        ...
        <section id="features" className="py-24 bg-gradient-to-b from-background to-background/70">
          <Container>
            <div className="mx-auto max-w-2xl text-center">
              ...
              <h2 className="text-3xl font-semibold tracking-tight sm:text-5xl bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/80">
        ...
        <section id="how-it-works" className="relative overflow-hidden py-24 sm:py-32 bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
          ...
          <Container className="relative">
            <div className="mx-auto max-w-3xl text-center mb-16">
              ...
              <h2 className="text-4xl font-bold tracking-tight sm:text-5xl bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/70">
        ...
        <section className="py-24 bg-gradient-to-b from-background to-muted/20">
          <Container>
            <div className="mx-auto max-w-3xl text-center mb-16">
              ...
              <p className="mt-6 text-xl text-muted-foreground max-w-2xl mx-auto">
                Hear directly from restaurant owners who have transformed their business with DineEase
              </p>
            </div>

            <div className="mx-auto grid gap-8 md:grid-cols-3">
              {testimonials.map((testimonial, index) => (
                <div key={index} className="relative p-6 rounded-2xl bg-card shadow-md border border-muted/20 backdrop-blur-sm">
                  <div className="absolute -top-4 left-6 text-primary text-6xl opacity-20">"</div>
                  <p className="relative text-lg text-muted-foreground pt-2">"{testimonial.text}"</p>
          ...
          <Container>
            ...
            <div className="mx-auto grid max-w-lg grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-3">
              {pricing.map((tier, index) => (
                ...
                >
                  {index === 1 && (
                    <div className="absolute -top-5 left-0 right-0 mx-auto w-fit px-6 py-1.5 text-xs font-bold uppercase tracking-wider text-primary-foreground bg-primary rounded-full">
                      Most Popular
                    </div>
                  )}
